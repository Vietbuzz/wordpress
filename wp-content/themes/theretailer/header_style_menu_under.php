                ...
                <div class="gbtr_dynamic_shopping_bag">
                    ...
                    ">
                        <div class="gbtr_little_shopping_bag">
                            ...
                            <div class="overview"><?php WC()->cart->get_cart_total(); ?> <span class="minicart_items">/ <?php echo sprintf( _n( '%d item', '%d items', WC()->cart->cart_contents_count, 'theretailer' ), WC()->cart->cart_contents_count ); ?></span></div>
