...
if ( ! class_exists( 'GBT_InstallWizard' ) ) {
	...
	class GBT_InstallWizard {
		...
		public function setupWizard() {
			...
			$default_steps = array(
				'introduction' => array(
					'name'    => __( 'Introduction', 'theretailer' ),
		...
		public function setup_wizard_steps() {
			...
			<div class="gbt-wizard-logo <?php echo GBTHELPERS::theme_slug(); ?>">
				<a href="#">
					<img src="<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/theretailer-logo.png'; ?>" <?php echo file_exists(get_template_directory() .'/inc/admin/wizard/images/theretailer-logo@2x.png')? 'srcset="'.get_template_directory_uri() .'/inc/admin/wizard/images/theretailer-logo@2x.png 2x'.'"': '' ; ?> alt="Logo">
				</a>
			</div>
		...
		public function gbt_setup_introduction() {
			?>
				<div class="wrapper wizard-introduction" style="background-image:url(<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/theretailer-setup.jpg'; ?>);">
					<div class="center">
						<h1><?php esc_html_e( GBTHELPERS::theme_name() . '\'s', 'theretailer');?> <br/> <?php esc_html_e('Theme Setup Wizard', 'theretailer' ); ?></h1>
			...
			?>
				<div class="wrapper wizard-plugins">
					...
					<div class="content-info">
						...
						<p><?php _e( 'Install the required plugins before importing the demo content.', 'theretailer' ); ?></p>
					</div>
							...
							<div class="plugin-install">
								...
								<?php if ( ! empty( $plugin['status'] ) && ($plugin['status'] != 'no-action') ) : ?>
										<a  class="button ajax-request <?php echo esc_html( $plugin['status'] ); ?>-now" 
											...
											<?php echo ($plugin['status'] == 'install') ? esc_html_e( 'Install Now', 'theretailer' ) : ''; ?>
											<?php echo ($plugin['status'] == 'update') ? esc_html_e( 'Update Now', 'theretailer' ) : ''; ?>
											<?php echo ($plugin['status'] == 'activate') ? esc_html_e( 'Activate', 'theretailer' ) : ''; ?>
										</a>
		...
		public function gbt_setup_demo() {
			...
			<div class="wrapper wizard-demo-import">
				...
				<div class="demo-icon <?php echo ( ! $is_required_plugins === true) ? 'error' : '' ?>">
					...
					<?php else : ?>
						<p class="error-info"><?php _e( 'Please make sure <b>Visual Composer</b> and <b>WooCommerce</b> are installed and activated before importing the demo content.', 'theretailer' ); ?></p>
					<?php endif; ?>
				</div>
				...
				<!-- <p class="ocdi__ajax-loader  js-ocdi-ajax-loader">
					<span class="spinner"></span> <?php esc_html_e( 'Importing, please wait!', 'theretailer' ); ?>
				</p> -->
		...
		public function gbt_setup_final() {
			...
			<div class="wrapper wizard-ready">
				<div class="content-done" style="background-image:url(<?php echo get_template_directory_uri() .'/inc/admin/wizard/images/theretailer-setup.jpg'; ?>);">
					<div class="center">
						<h1><?php _e( 'Setup has been<br/> completed successfully!', 'theretailer' ); ?></h1>
				...
				<div class="further-info">
					...
					<div class="column last">
						<ul>
							...
							<li><a href="<?php echo esc_url( GBTHELPERS::support_link() ); ?>" target="_blank"><span class="dashicons dashicons-editor-help"></span><?php esc_html_e( 'Help Center / Support', 'theretailer' ); ?></a></li>
						</ul>
					</div>
				</div>
		...
		public function _get_plugins() {
			...
			$newplugins['the-retailer-portfolio'] = $plugins['the-retailer-portfolio'];
