...
if (!isset($theretailer_theme_options['gb_main_font'])) $theretailer_theme_options['gb_main_font'] = "Radnika Next Alt";
if (!isset($theretailer_theme_options['gb_secondary_font'])) $theretailer_theme_options['gb_secondary_font'] = "HK Nova";
