...
<?php } ?>
                ...
                <div class="gbtr_dynamic_shopping_bag">
                    ...
                    ">
                        <div class="gbtr_little_shopping_bag">
                            <div class="title"><a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php _e('Cart', 'woocommerce'); ?></a></div>
                    ...
                    <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="gbtr_little_shopping_bag_wrapper_mobiles"><span><?php echo $woocommerce->cart->cart_contents_count; ?></span></a>
    ...
    <?php if ( THE_RETAILER_EXTENDER_IS_ACTIVE && get_option( 'tr_custom_code_footer_js', '' ) != '' ) : ?>
        <?php echo get_option( 'tr_custom_code_footer_js', '' ); ?>
    <?php endif; ?>
