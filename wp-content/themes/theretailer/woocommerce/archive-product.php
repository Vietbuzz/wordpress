...
$category_header_src = "";
if ( THE_RETAILER_EXTENDER_IS_ACTIVE && class_exists('TRCategoryHeaderImage') )  {
	$tr_cat_header = new TRCategoryHeaderImage;
	$category_header_src = $tr_cat_header->woocommerce_get_header_image_url();
}
...
<div class="global_content_wrapper">
	...
	<div <?php if ( get_option( 'tr_category_header_parallax', 'yes' ) === 'yes' ) : ?>data-stellar-background-ratio="0.5"<?php endif;?> class="category_header <?php if ( $description ) : ?>with_term_description<?php endif; ?> <?php if ($category_header_src != "") : ?>with_featured_img<?php endif; ?>" style="background-image:url(<?php echo $category_header_src ; ?>)">
