                    ...
                    <div class="grid_8 push_2">
                        <div class="entry-meta">
                            <?php
                                ...
                                printf( __( 'Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at&nbsp;<a href="%3$s" title="Link to full-size image"> <i class="picture-icon"></i>&nbsp; %4$s &times; %5$s</a> in &nbsp;<a href="%6$s" title="Return to %7$s" rel="gallery"><i class="category-icon"></i>&nbsp; %7$s</a> by <span class="author"><a href="%8$s">%9$s</a></span>', 'theretailer' ),
